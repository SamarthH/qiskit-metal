...
class TransmonPocketTeethCustom(BaseQubit):
    ...
    def make_pocket(self):
        ...
        circ_left_top = draw.Point(-pad_width_top / 2., +(pad_height_top + pad_gap) /
                                   2.).buffer(pad_height_top / 2,
                                              resolution=16,
                                              cap_style=CAP_STYLE.round)
        circ_right_top = draw.Point(pad_width_top / 2., +(pad_height_top + pad_gap) /
                                    2.).buffer(pad_height_top / 2,
                                               resolution=16,
                                               cap_style=CAP_STYLE.round)
        ...
        circ_left_bot = draw.Point(-pad_width_bot / 2, -(pad_height_bot + pad_gap) /
                                   2.).buffer(pad_height_bot / 2,
                                              resolution=16,
                                              cap_style=CAP_STYLE.round)
        circ_right_bot = draw.Point(pad_width_bot / 2, -(pad_height_bot + pad_gap) /
                                    2.).buffer(pad_height_bot / 2,
                                               resolution=16,
                                               cap_style=CAP_STYLE.round)
